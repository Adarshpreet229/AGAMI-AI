...
import edge_tts # Import edge_tts for text to speechfunctions
...
def TTS(Text, func=lambda r=None: True):
    while True:
        try:
            # Convert text an audio file asynchronously 
...
if __name__ == "__main__":
    while True:
        ...
        # If you want the entire text to be spoken without any interferences.
