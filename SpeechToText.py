...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "why", "which", "whose", "whom", "can you", "what's", "where's", "how's", "can you", "are you"]
...
def SpeechRecognition():
    ...
    while True:
        try:
            ...
            if Text:
                # Stop recognition recognition by clicking the stop button.
                ...
                if InputLanguage.lower() == "en" or "en" in InputLanguage.lower():
                    ...
                    # If the input language is not Enlish, translate the text and return it.
